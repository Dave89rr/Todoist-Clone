...
class SignUpForm(FlaskForm):
    ...
    email = StringField('email', validators=[Length(min=1, max=40, message='Email must be valid and less than 40 characters long.'), user_exists, Email(check_deliverability=True, granular_message=True)])
